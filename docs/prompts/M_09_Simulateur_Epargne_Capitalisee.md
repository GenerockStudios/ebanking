...
# OBJECTIF EXCLUSIF DU PROMPT 9

## Sujet : Outil Interactif: Simulateur d'Épargne sur Capitalisation
**Acteur Principal** : Caissier (3)
**Focus Imposé** : Outil combinant données réelles (`type_comptes.taux_interet`) et formulaire interactif Javascript calculant la projection des rendements mois par mois sans enregistrer de tables. Fournit une 'Simulation Client' imprimable en RDV.
