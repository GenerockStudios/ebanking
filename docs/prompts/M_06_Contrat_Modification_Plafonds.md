...
# OBJECTIF EXCLUSIF DU PROMPT 6

## Sujet : Gestion Experte et Contrat de Déplafonnement
**Acteur Principal** : Administrateur (1)
**Focus Imposé** : Interface pour consulter et modifier les `plafonds_comptes`. Génére au clic un 'Contrat d'Engagement de Modification de Plafonds' à double signature (Client et Banque) justifiant légalement ce paramétrage système.
