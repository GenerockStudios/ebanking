...
# OBJECTIF EXCLUSIF DU PROMPT 10

## Sujet : Dashboard Analytique de Snapshot Fin de Mois
**Acteur Principal** : Administrateur (1) / Chef d'agence
**Focus Imposé** : Rapport extrêmement poussé analysant la table `historique_soldes`. Calcul d'évolutions M-1/M en pourcentage. Affichage d'un tableau financier strict (Bilan) et d'une jauge visuelle (CSS), prêt pour un rendu d'impression A4 Paysage.
