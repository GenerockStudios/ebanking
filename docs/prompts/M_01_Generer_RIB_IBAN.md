...
## Sujet : Génération et Impression de RIB/IBAN (UI/Print Expert)
**Acteur Principal** : Caissier (3) & Administrateur (1)
**Focus Imposé** : Exploiter la table `comptes` et `clients` pour générer un RIB complet, formel, calculé à la volée (pas stocké), avec formatage de code guichet et IBAN fictifs stricts.
