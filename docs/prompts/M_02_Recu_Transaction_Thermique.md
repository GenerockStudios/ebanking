...
# OBJECTIF EXCLUSIF DU PROMPT 2

## Sujet : Impression Thermique/A4 des Reçus de Transactions
**Acteur Principal** : Caissier (3)
**Focus Imposé** : Réexploiter `transactions` pour générer un ticket de caisse post-opération immédiat. Format spécifique (Ticket de caisse long) ou A4 coupé, ultra réaliste, reprenant le libellé, le solde restant et la date/heure.
