<?php
/**
 * depot.php - Formulaire de dépôt avec saisie prédictive AJAX.
    ...
    <div class="op-container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h1>Nouveau Dépôt</h1>
                <p>Créditer le compte d'un client</p>
            </div>
            ...
            <form method="POST" action="<?= BASE_URL ?>?controller=Caisse&action=depot">
                ...
                <div class="input-group">
                    ...
                    <label for="montant">Montant du Dépôt (FCFA)</label>
                </div>
                <button type="submit" class="submit-btn">Confirmer le Dépôt</button>
            </form>
        </div>
